...
public class MemPool implements MemPoolInterface
{
    ...
    public MemHandle insert(byte[] space, short size)
    {
        ...
        } else
        {
             ...
             * the string add the string in and adjust the free block which houses it. check
             * if the freeblock is empty, if so, free it and adjust the list get the memory
             * handle with the starting position of the inserted string
             */
